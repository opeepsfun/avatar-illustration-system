const SquareGlasses = {
    ...
    draw: (glassFrameColor = "#000000") => {
        return `
        <path d='M36.5 42.5L2 49.125' stroke='${glassFrameColor}' stroke-width='4' stroke-linecap='round' />
        <path
        ...
        <path
            ...
            stroke-width='4'
        />
        <path d='M85.5 37.125L107.5 33.625' stroke='${glassFrameColor}' stroke-width='4' />
        `;
    }
};

export default SquareGlasses;
